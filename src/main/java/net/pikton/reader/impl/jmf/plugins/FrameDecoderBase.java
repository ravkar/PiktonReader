 ...
 *
 */
public abstract class FrameDecoderBase implements Effect, ReaderObservable{
	static Logger logger = LoggerFactory.getLogger(FrameDecoderBase.class);
